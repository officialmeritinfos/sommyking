                                ...
                                <table id="example" class="display min-w850">
                                    ...
                                    @foreach($tickets as $ticket)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.ticket_detail',['id'=>$ticket->reference])}}"
                                                   class="btn btn-sm btn-primary">View</a>

                                                <a href="{{route('admin.support.close',['id'=>$ticket->reference])}}"
                                                   class="btn btn-sm btn-success">Close Ticket</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('admin.support.new')}}">
                        @csrf
                        <div class="form-row">
